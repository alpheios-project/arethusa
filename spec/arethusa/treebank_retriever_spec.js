...
describe('TreebankRetriever', function() {
  ...
  describe('parse', function() {
    ...
    xit('parses treebank data in XML format and returns an array of sentences', function() {
    ...
    xit('parses comments in treebank data', function() {
    ...
    xit('does not fail when a treebank consists of a single sentence', function() {
    ...
    xit('does not fail when a sentence consists of a single word', function() {
    ...
    xit('succeeds when a treebank is namespace prefixed', function() {
